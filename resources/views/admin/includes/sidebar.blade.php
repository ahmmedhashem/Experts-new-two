<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-folder-o"></i>
                <span class="menu-title" data-i18n="nav.dash.main">Experts Data</span>
                <span
                    class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\User::count() }}</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{ route('admin.experts.data') }}"
                                        data-i18n="nav.dash.ecommerce">display all </a>
                    </li>
                </ul>
            </li>

            <li class="nav-item"><a href=""><i class="la la-commenting"></i>
                <span class="menu-title" data-i18n="nav.dash.main">Policies</span>

                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{ route('admin.terms') }}"
                                        data-i18n="nav.dash.ecommerce">Update </a>
                    </li>
                </ul>
            </li>
