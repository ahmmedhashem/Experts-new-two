                                ...
                                <div class="card-body">
                                    <form class="form"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <h4 class="form-section"><i class="ft-home"></i> General Informations  </h4>
                                            <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> Affiliation/Institution
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> Date Of Birth
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="email"
                                                               class="form-control"
                                                               placeholder="Please enter your emaol"
                                                               value="{{old('email')}}"
                                                               name="email">
                                                        @error("email")
                                                        <span class="text-danger">{{$message}}</span>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> Emirates
                                                        </label>
                                                        <select name="emirate_id" class="select2 form-control">
                                                            <optgroup label="Choose Emirates ">
                                                                <option value="" selected>--Choose--</option>
                                                                @if($emirtes && $emirtes -> count() > 0)
                                                                    @foreach($emirtes as $emirte)
                                                                        <option
                                                                            value="{{$emirte -> id }}">{{$emirte -> name}}</option>
                                                                    @endforeach
                                                                @endif
                                                            </optgroup>
                                                        </select>
